...
mfccs_new = np.load('D:\\individualProject\\soundfile\\mfcc\\average_common_voice_en_38365575.npy')
...
np.save('converted_female_mfcc_38365575.npy', converted_female_mfcc)
