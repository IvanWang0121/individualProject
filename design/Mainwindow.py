...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.statusBar().showMessage("Welcome to Audio Processing Tools")
        # 调用创建按钮
        self.create_button()
        ...
        label.setStyleSheet('color:purple')  # 字体颜色
    ...
    def create_button(self):
        ...
        btn1.setStyleSheet("background-color: white; color: black;")  # 按钮的背景，文本颜色=
        ...
        btn2.setStyleSheet("background-color: white; color: black;")  # 按钮的背景，文本颜色=
        ...
        btn3.setStyleSheet("background-color: white; color: black;")  # 按钮的背景，文本颜色=
        ...
        btn4.setStyleSheet("background-color: white; color: black;")  # 按钮的背景，文本颜色
